...
dotenv.load_dotenv('/Users/siddharthakosti/Downloads/agentic_tracing/ragaai-catalyst/.env', override=True)  
...
# Initialize tracer
project_name = "dataset_log_issue_2"

tracer = Tracer(
    project_name=project_name,
    dataset_name="log_issue_v3",
